...
class LiRPANet:
    ...
    def build(self, x, c, rhs,
        ...
        batch_handler = BatchHandler(
            ...
            need_alphas, full_alpha_info,
            reference_alphas=reference_alphas,
            clip_in_alpha_crown=clip_in_alpha_crown,
        )
        ...
        for now_batch in range(total_batches):
            ...
            # Get batch input.
            batch_x, batch_c, batch_rhs, stop_criterion_func, batch_interm_bounds, batch_alphas, batch_or_spec_size = (
            ...
            if bounding_method == 'alpha-crown':
                ...
                lb, ub, aux_reference_bounds = self.net.init_alpha(
                    ...
                    bound_upper=False, reference_alphas=batch_alphas)
