...
class ConfigHandler:
    ...
    def add_common_options(self):
        ...
        h = ["cache"]
        self.add_argument("--enable_instance_cache", action='store_true',
                          help='Enable per-instance artifact cache for warm-starting alpha optimization and branching hints.',
                          hierarchy=h + ["enabled"])
